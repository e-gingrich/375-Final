...
public:
  ...
  ///   the Scene.
  /// \param[in] projectionMatrix The projection matrix that is used when drawing 
  ///   the Scene.
  void
...
/// Map of meshes in the scene
std::map<std::string, Mesh*> meshes;

/// Points to the active mesh
std::map<std::string, Mesh*>::iterator activeMesh;
